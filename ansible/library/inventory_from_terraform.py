...
config.append('registry_username={}'.format(outputs['aws_iam_access_key_asg_user_id']['value']))
config.append('registry_password={}'.format(outputs['aws_iam_access_key_asg_user_secret']['value']))
