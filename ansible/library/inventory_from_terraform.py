...
config.append('ansible_ssh_user=ec2-user')
config.append('ansible_ssh_private_key_file=files/id_rsa')
config.append('ansible_become=yes')
config.append('registry_username={}'.format(outputs['aws_iam_access_key_ecr_user_id']['value']))
config.append('registry_password={}'.format(outputs['aws_iam_access_key_ecr_user_secret']['value']))
config.append('registry_url={}'.format(outputs['aws_ecr_repository_main_repository_url']['value']))
